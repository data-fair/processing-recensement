    ...
    if (jeuRP) {
      for (const code of codes) {
        ...
        if (!processingConfig.filter || filter) {
          ...
          if (compteur === 20) {
            await log.error(`La commune ${code} n'a pas pu être récupérée`)
          }
          done = false
          compteur = 0
          while (!done && compteur < 20) {
          ...
          if (compteur === 20) {
            await log.error(`La commune ${code} n'a pas pu être récupérée pour les informations sur le sexe et l'age`)
          }
          done = false
          compteur = 0
          while (!done && compteur < 20) {
          ...
          if (compteur === 20) {
            await log.error(`La commune ${code} n'a pas pu être récupérée pour les informations sur les voitures`)
          }
          done = false
          ...
          if (commune.population_municipale >= 2000) {
            ...
            if (compteur === 20) {
              await log.error(`La commune ${code} n'a pas pu être récupérée pour les informations sur les ménages`)
            }
